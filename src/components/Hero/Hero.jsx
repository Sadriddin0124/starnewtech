...
const Hero = () => {
  ...
  return (
    <section className='w-[100%] relative flex justify-center min-h-[100vh] py-[120px] px-[20px] bg-[#000000a8]'>
      <img src={HeroImg} alt="HeroImg" className='w-[100%] h-[100%] absolute z-[-1] top-0 left-0'/>
      <div className='max-w-[1200px] w-[100%]'>
        <div className='flex flex-col gap-[20px]'>
            <h1 className='text-[45px] font-[600] text-white'>NewTec - {t("hero.title")}</h1>
            <p className='text-[20px] text-white mb-[50px]'>{t("hero.subtitle")}</p>
            <div className='w-[100%] flex justify-between gap-[20px]'>
                {
                    cards?.map((item,index)=> {
                        return <div key={index} className='bg-white gap-[10px] p-[20px] rounded-md flex flex-col justify-between items-center max-w-[340px] w-[100%]'>
