...
const SpecialOrders = () => {
  ...
  return (
    <section className="bg-gray-100 flex justify-center py-[150px] ">
      <div className="container max-w-[1200px] mx-auto px-[16px] text-center">
        <div className="p-6 bg-blue-50 rounded shadow ease-linear duration-300 hover:bg-[#E57F34] cursor-pointer hover:text-white mb-12">
          <h2 className="text-[20px] md:text-[24px] font-bold mb-4">{t("specialOrders.title1")}</h2>
          <p>{t("specialOrders.subtitle1")}</p>
        </div>
        <div className="mb-12">
          <h2 className="text-[20px] md:text-[24px] font-bold mb-4">{t("specialOrders.title2")}</h2>
        ...
        <div className="p-6 group bg-gray-50 rounded shadow ease-linear duration-300 hover:bg-[#E57F34] cursor-pointer hover:text-white">
          <h2 className="text-[20px] md:text-[24px] font-bold mb-4">{t("specialOrders.title5")}</h2>
